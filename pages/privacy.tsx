...
const Privacy: NextPage = () => {
  return (
    <Stack bg="gray.100" p={6} spacing={6}>
      <Heading as="h1" size="2xl">
        Privacy Policy
      </Heading>
      <Text>Updated at 2022-10-12</Text>
      <Text>
        {" "}
        hacktobered (“we,” “our,” or “us”) is committed to protecting your
        privacy. This Privacy Policy explains how your personal information is
        collected, used, and disclosed by hacktobered.
      </Text>
      <Text>
        ...
        hacktobered. By accessing or using our Service, you signify that you
        ...
        <Link href="https://termify.io" target="_blank" rel="noreferrer">
          Termify
        </Link>
        .
      </Text>
      ...
      <Text>
        ...
        <UnorderedList>
          ...
          <ListItem>
            ...
            it refers to hacktobered, that is responsible for your information
            under this Privacy Policy.
          </ListItem>
          <ListItem>
            Country: where hacktobered or the owners/founders of hacktobered are
            based, in this case is Canada
          </ListItem>
          <ListItem>
            Customer: refers to the company, organization or person that signs
            up to use the hacktobered Service to manage the relationships with
            your consumers or service users.
          </ListItem>
          <ListItem>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit hacktobered
          ...
          <ListItem>
            ...
            hacktobered or are under contract to perform a service on behalf of
            one of the parties.
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            Service: refers to the service provided by hacktobered as described
          ...
          <ListItem>
            Website: hacktobered's site, which can be accessed via this URL:
            https://www.hacktobered.com/
          </ListItem>
          <ListItem>
            You: a person or entity that is registered with hacktobered to use
            the Services.
          </ListItem>
        </UnorderedList>
      </Text>
      ...
      <Heading as="h1" size="2xl">
        When does hacktobered use end user information from third parties?
      </Heading>
      <Text>
        hacktobered will collect End User Data necessary to provide the
        hacktobered services to our customers.
      </Text>
      <Text>
      ...
      <Heading as="h1" size="2xl">
        When does hacktobered use customer information from third parties?
      </Heading>
      <Text>
        ...
        in becoming a hacktobered customer, we receive information from a third
        party that provides automated fraud detection services to hacktobered.
      ...
      <Text>
        hacktobered will collect personal information that you submit to us. We
      ...
      <Text>
        ...
        hacktobered to you and fulfill the purposes described in this policy.
      ...
      <Text>
        ...
        any information you transmit to hacktobered or guarantee that your
      ...
      <Text>
        hacktobered is incorporated in Canada. Information collected via our
      ...
      <Heading as="h1" size="2xl">
        Is the information collected through the hacktobered Service secure?
      </Heading>
      <Text>
      ...
      <Text>
        ...
        hacktobered collects depend on your relationship with hacktobered.
      ...
      <Text>
        ...
        the assets of hacktobered or any of its Corporate Affiliates (as defined
        herein), or that portion of hacktobered or any of its Corporate
      ...
      <Text>
        ...
        hacktobered, whether by ownership or otherwise. Any information relating
      ...
      <Text>
        By using hacktobered or contacting us directly, you signify your
      ...
      <Text>
        ...
        hacktobered. We are not responsible for the content, accuracy or
      ...
      <Text>
        hacktobered uses "Cookies" to identify the areas of our website that you
      ...
      <Text>
        You acknowledge and agree that hacktobered shall not be responsible for
        ...
        or any other aspect thereof. hacktobered does not assume and shall not
      ...
      <Text>
        ...
        At hacktobered we strongly believe that your data privacy is very
      ...
      <Text>
        ...
        requirements of GDPR. hacktobered processes or stores all personal data
      ...
      <Text>
        Via Email:{" "}
        <Link href="mailto:hi@hacktobered.com">hi@hacktobered.com</Link>
      </Text>
    </Stack>
  );
};
